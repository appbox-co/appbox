...
- **Companion apps** available from the same library, including [Jellyfin](/apps/Jellyfin), [Emby](/apps/Emby), [Tautulli](/apps/Tautulli), [File Browser](/apps/FileBrowser), and [Nextcloud](/apps/Nextcloud).
...
[Tautulli](/apps/Tautulli) is useful for Plex monitoring and library activity. [Jellyfin](/apps/Jellyfin) and [Emby](/apps/Emby) are alternative media servers if you want to compare workflows or run an open-source option alongside Plex. [File Browser](/apps/FileBrowser) gives you a straightforward web file manager. [Nextcloud](/apps/Nextcloud) is useful if you want private cloud storage and file sync in the same Appbox environment.
