...
excerpt: Day 3 of Launch Week. Full KVM virtual private servers are now available on Appbox. Choose from Ubuntu, Debian, Arch Linux, Fedora, or Rocky Linux and get root access to a real VM.
author_id: rid
...
We're launching with five Linux distributions:
