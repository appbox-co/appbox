---
title: Components
description: Mastering components in your MDX files
sort: 2
---

Components are automatically injected, without the need for manual import, into all MDX files.
This means you can use any component that is available!
