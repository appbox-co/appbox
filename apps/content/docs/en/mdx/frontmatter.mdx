---
title: Frontmatter
description: Learn how to use frontmatter in MDX files.
sort: 3
---

The frontmatter is an important part of an MDX file.
It is used to define information about the content of the file,
such as title, description, author, publication date, etc.
...
<Alert className="my-4" variant="warning">
  ...
  <AlertDescription className="pl-2">
    ...
    It must match the author `id` defined in the `src/config/blog.ts` file,
...
<Alert className="my-4" variant="warning">
  ...
  <AlertDescription className="pl-2">
    ...
    Images must be stored in the `public/blog-og` folder.
