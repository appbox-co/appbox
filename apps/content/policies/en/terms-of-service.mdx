...
In accordance with the Online Safety Act 2023 (OSA) of the United Kingdom, Appbox has implemented the following measures to protect users and comply with UK regulations:

1. **Illegal Content**: Users are prohibited from using our Services to store, distribute, or promote illegal content, particularly content that:
   - Constitutes a relevant criminal offense under UK law
   - Endangers national security
   - Involves child sexual exploitation and abuse (CSEA)
   - Promotes terrorism or terrorist activities
   - Depicts or encourages violence against protected groups
   - Facilitates fraud, identity theft, or cybercrime

2. **Harmful Content**: Users must not use our Services to distribute or promote content that could reasonably be considered harmful, especially to children, including but not limited to:
   - Content encouraging self-harm or suicide
   - Content promoting eating disorders
   - Cyberbullying and harassment materials
   - Online abuse targeting protected characteristics
   - Content that glorifies dangerous behavior
...
4. **Content Moderation**: Appbox employs both automated systems and human review to moderate content in compliance with the OSA. We reserve the right to remove content, suspend services, or terminate accounts found to be in violation of this policy.

5. **Cooperation with Authorities**: We will cooperate with UK regulatory authorities, including Ofcom, in addressing illegal content. This includes providing information as required by law and complying with enforcement notices.

6. **Risk Assessment**: We conduct regular risk assessments regarding illegal content and content harmful to children, implementing proportionate measures to mitigate identified risks.

7. **Age Verification**: When applicable, users must ensure appropriate age verification mechanisms are in place for any services they host that could potentially be accessed by children.

By using our Services, you acknowledge these additional requirements and agree to comply with the Online Safety Act 2023 and all other applicable UK laws.
...
- Any VOD (Video on Demand) hosting  
...
- Content that constitutes hate speech or incites violence
- Fraudulent or deceptive materials
- Any content that violates the UK Online Safety Act or other applicable laws
