...
export function VersionsTable({
  ...
  return (
    <section className="py-16">
      ...
      <div className="mt-4 flex items-start gap-2 rounded-lg border border-indigo-500/20 bg-indigo-500/5 px-4 py-3 text-sm text-muted-foreground">
        <Zap className="mt-0.5 size-4 shrink-0 text-indigo-500" />
        <p>
          Need more resources? Use{" "}
          <span className="font-medium text-foreground">Per-App Boost</span> to
          allocate extra App Slots and increase RAM and CPU by 10% per slot. See
          the FAQ below for details.
        </p>
      </div>
    </section>
  )
