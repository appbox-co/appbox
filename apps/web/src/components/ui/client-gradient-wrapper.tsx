...
// Client-only component that renders the animated gradient
export function ClientGradientWrapper(props: GradientWrapperProps) {
  return <GradientTracing {...props} />
}

// Static SVG version that matches the client animation
function StaticGradient({
  ...
  // Static gradient ID for SSR compatibility
  const baseGradientId = "ssr-static-gradient"

  return (
    <div className={className} style={{ width, height, opacity }}>
      <svg width={width} height={height} viewBox="0 0 161 170" fill="none">
        ...
        <g fill="none" fillRule="evenodd">
          <g stroke={`url(#${baseGradientId})`} strokeWidth={strokeWidth}>
            <path d="M80.480628,0.547265265 L160.427241,36.0900032 L160.499759,133.801211 L153.068633,137.112892 L81.0011238,169.229772 L81.0009996,71.351267 L1.22926171,35.8423953 L80.480628,0.547265265 Z M152.585375,50.4897451 L93.7986825,76.7021663 L93.7986825,155.85229 L152.585375,129.639869 L152.585375,99.7534172 L143.174456,94.4158258 L152.585375,80.685758 L152.585375,50.4897451 Z M30,88.9248734 L49,97.5258859 L49,87.7512656 L30,79.1502531 L30,88.9248734 Z M68,155 L49,146.398988 L49,117.075127 L30,108.474114 L30,137.797975 L11,129.196963 L11,51 L68,76.8030375 L68,155 Z" />
...
// SSR compatible version using React Suspense
export function GradientWrapper(props: GradientWrapperProps) {
  return <StaticGradient {...props} />
}
