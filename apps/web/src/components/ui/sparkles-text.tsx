...
interface SparklesTextProps {
   ...
   * */
  as?: ReactElement<React.HTMLAttributes<HTMLElement>>
...
function SparklesText({
  ...
  return (
    ...
    >
      <span data-slot="sparkles-wrapper" className="relative inline-block">
        ...
        <strong data-slot="text">{text}</strong>
      </span>
    </div>
  )
}
